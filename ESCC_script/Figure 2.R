...
for (h in hallmark) {
    ...
    meta1$development <- factor(meta1$development, levels = c('NOR', 'BCH', 'mD', 'MD', 'SD&CIS', 'ICA', 'MCA'))
    ...
    meta2$ME <-factor(meta2$ME,levels = c('NOR-ME','BCH-ME','mD-ME','MD-ME','SD&CIS-ME','ICA-ME','MCA-ME'))
    ...
    merge <- rbind(de, me)
    merge$dev <- factor(merge$dev, levels = c('NOR', 'BCH', 'mD', 'MD', 'SD&CIS', 'ICA', 'MCA'))
    ...
    merge1$dev <- factor(merge1$dev, levels = c('NOR', 'BCH', 'mD', 'MD', 'SD&CIS', 'ICA', 'MCA'))
