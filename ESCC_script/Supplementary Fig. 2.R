...
celltype <- c('DC_C1_CLEC9A','DC_C2_CD1C','DC_C3_CD1A', 'DC_C4_LAMP3','DC_C5_IL3RA','Mono/Mac_C1_NLRP3', 'Mac_C2_SPP1','Mac_C3_C1QC',
...
T_plotG <- c("CFD","IGFBP6","GPX3","PI16","IGF1","DPT","CXCL12","COL4A4","MMP11","POSTN","COL1A1","CTHRC1","APOE","COL13A1",
