...
cell_type_colors <- c( "CD8_C6_CD39" = "#E31A1C", "CD4_C7_OX40" = "#1F78B4", "Mac_C2_SPP1" = "#33A02C", "FB_C3_COL1A1" = "#6A3D9A", "Endo_C3_RGCC" = "#FF7F00" )

group_colors <- c(  "MIMER" = "#bd2628",  "other" = "#cccccc" )
